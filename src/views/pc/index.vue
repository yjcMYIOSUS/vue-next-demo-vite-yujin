  ...
  <div v-if="loading == false">
    ...
    <main id="main" >
      ...
      <div class="preview" >
        ...
        <div class="preview-image" id="preview-image-id" :style="welcomeImage">
          <!-- <h2 class="preview-motto" id="motto" v-part> -->
          ...
          <div class="preview-overlay">
            <svg class="preview-waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <g class="preview-parallax">
                <use xlink:href="#gentle-wave" x="48" y="0" fill="rgba(var(--color-background-rgb), 0.7" />
                <use xlink:href="#gentle-wave" x="48" y="3" fill="rgba(var(--color-background-rgb), 0.5)" />
                <use xlink:href="#gentle-wave" x="48" y="5" fill="rgba(var(--color-background-rgb), 0.3)" />
                <use xlink:href="#gentle-wave" x="48" y="7" fill="rgb(var(--color-background-rgb))" />
              </g>
            </svg>
          </div>
        </div>
        ...
        <div class="preview-scroll">
          <a href="#container" class="smooth-scroll">
      ...
      <div class="container" id="container">
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 post-item" @click="jumPage(item.id)" v-for="(item, index) in articleList" :key="index">
            <div class="post-wrap">
              ...
              <div class="post-content">
                <h5 class="post-title">
                  <span :title="item.arttitle" >{{item.arttitle}}</span>
                </h5>
        ...
        <section class="paginator">
          ...
          <!-- <Pagination :total='total' :current-page='currentPage' @change-page='changePage'/> -->
          <Pagination :dataAll="articlePage" :dataCur="currentPage" :datanum="dataNum" :dataDatanum="dataDatanum" @change-page="changePage" ></Pagination>
        </section>
      </div>
    </main>
    <!-- 抽屉组件 -->
...
<style lang="scss">
    @import "../../assets/css/pc/wave.scss";
</style>
